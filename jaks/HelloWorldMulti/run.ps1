...
# Application Name: HelloWorldMulti
# Application description and free-form requirements:
<#
Print hello world in 4 different human languages
#>

$APPNAME = "HelloWorldMulti"
$main_script = "HelloWorldMulti.py"
...
print("Bonjour le monde en Français")
print("Hallo Welt auf Deutsch")
