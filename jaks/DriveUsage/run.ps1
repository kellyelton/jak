...
# Application Name: DriveUsage
# Application description and free-form requirements:
<#
List the used and free space of all drives in GB
#>

$APPNAME = "DriveUsage"
$main_script = "DriveUsage.py"
...
def main():
    ...
    for partition in psutil.disk_partitions():
        ...
        print("{} {} GB free of {} GB".format(partition.mountpoint, usage.free // (2**30), usage.total // (2**30)))
    return 0
...
# create alias from "F:\Source\jak\jak.ps1" to jak
new-alias -name jak -value "& F:\Source\jak\jak.ps1" -Scope Global
